 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.streaksphere.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.streaksphere'; // ios bundle id
const PACKAGE = 'com.streaksphere'; // android package name
