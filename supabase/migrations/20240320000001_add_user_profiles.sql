...
-- Update habits table to include more user-specific fields
ALTER TABLE habits
ADD COLUMN reminder_time TIME,
ADD COLUMN reminder_days INTEGER[], -- Array of days (0-6) for reminders
ADD COLUMN color TEXT DEFAULT '#4F46E5'; -- Default color for habit
